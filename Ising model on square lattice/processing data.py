...
# load data
train_config1 = np.load('./raw data/spin_0-1.npy')
train_config2 = np.load('./raw data/spin_4-5.npy')
train_config = np.concatenate((train_config1, train_config2), axis=0)
train_T1 = np.load('./raw data/T_0-1.npy')
train_T2 = np.load('./raw data/T_4-5.npy')
